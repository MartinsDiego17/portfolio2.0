...
const MyDetails = () => {
    ...
    return (
        <article className='w-[65%] max-sm:w-[100vw] max-sm:text-center' >
            ...
            <h2 class="gradient-text text-[#09f] 2xl:text-[2.5rem] max-sm:text-[1.5rem] text-[2rem] max-sm:text-center">FULL STACK DEVELOPER</h2>
            ...
            <div class="redes flex justify-star mt-[1.2%] max-sm:block max-sm:text-center" >
                <p class="2xl:text-[1.2rem] max-sm:w-fit max-sm:mb-[4%] max-sm:px-[3%] max-sm:mt-[7%] max-sm:mx-auto max-sm:text-center mr-[1%] py-[.15%] px-[1%] rounded-[5px] font-extrabold text-[.8rem] bg-[#b9e3ff] text-[#0874c5]">Disponible para trabajar</p>
                <button>
            ...
            <Button className='2xl:text-[1.2rem] mt-4 opacity-100 text-[#8ed2ff]' color='primary' variant='flat' >Descargar curriculum</Button>
            <Button className='2xl:text-[1.2rem] mt-4 opacity-100 ml-3 text-[#8ed2ff]' color='primary' variant='flat' >Vista previa</Button>
        </article>
    )
}
